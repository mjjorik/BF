<?php
/**
 * Single Журнал Post Template
 * Boston Flowers
 */

$bf_post_id   = get_the_ID();
$bf_category  = get_post_meta($bf_post_id, "_bf_category", true) ?: (get_the_category() ? get_the_category()[0]->name : "Журнал");
...
// Get Russian Title & Content from Meta
$post_title   = get_post_meta($bf_post_id, "_bf_title_ru", true) ?: get_the_title();
$post_content = get_post_meta($bf_post_id, "_bf_content_ru", true) ?: get_the_content();
$post_excerpt = get_post_meta($bf_post_id, "_bf_excerpt_ru", true) ?: get_the_excerpt();
$bf_keys      = get_post_meta($bf_post_id, "_bf_key_points_ru", true) ?: $bf_keys;
...
$graph[] = ["@type" => "BreadcrumbList", "itemListElement" => [
    ["@type" => "ListItem", "position" => 1, "name" => "Главная", "item" => "https://bostonflowers.com/"],
    ["@type" => "ListItem", "position" => 2, "name" => "Журнал", "item" => "https://bostonflowers.com/journal"],
    ["@type" => "ListItem", "position" => 3, "name" => $post_title, "item" => $post_url],
]];

add_action("wp_head", function() use ($post_title, $post_excerpt, $post_url, $post_img, $graph) {
    echo "<title>" . esc_html($post_title) . " | Boston Flowers Журнал</title>" . "\n";
...
<section id="hero">
  ...
  <div class="hero-inner post-hero-inner">
    <div class="hero-left">
      <a href="/journal" class="post-back r">&#8592; Назад в журнал</a>
      ...
      <div class="post-meta r">
        ...
        <span><?php echo esc_html($bf_read_time); ?> мин чтения</span>
        <span class="post-meta-sep"></span>
        <span>Студия Boston Flowers</span>
      </div>
    </div>
...
<section id="trust-marquee">
  <div class="marquee-track">
    <div class="marquee-inner">
      ...
      <span class="marquee-item"><span>&#10022;</span>Доставка сегодня по Бостону</span>
      <span class="marquee-item"><span>&#10022;</span>Фото перед отправкой</span>
      <span class="marquee-item"><span>&#10022;</span>Авторские композиции</span>
      <span class="marquee-item"><span>&#10022;</span>Студия в Брайтоне, Бостон</span>
      <span class="marquee-item"><span>&#10022;</span>Ответ за 5 минут</span>
      <span class="marquee-item"><span>&#10022;</span><?php echo esc_html($bf_category); ?></span>
      <span class="marquee-item"><span>&#10022;</span>Доставка сегодня по Бостону</span>
      <span class="marquee-item"><span>&#10022;</span>Фото перед отправкой</span>
      <span class="marquee-item"><span>&#10022;</span>Авторские композиции</span>
  ...
  <div class="container">
    <div class="post-layout">
      <article class="post-body">
        ...
        <div class="bf-key r">
          <span class="bf-key-label">Главное в статье</span>
          <ul>
        ...
        <div id="post-faq" class="r d2" style="background:var(--ivory); padding: 80px 0; border-top:1px solid var(--bdl); margin-top: 60px;">
          <h2 class="serif" style="border-top:none; margin-top:0; padding-top:0;">Часто задаваемые <em>вопросы.</em></h2>
          <div class="faq-list">
      ...
      <aside class="post-sidebar">
        <div class="post-sidebar-card r">
          <span class="post-sidebar-label">Заказать сегодня</span>
          <p class="post-sidebar-title serif">Авторский букет,<br><em>доставка сегодня.</em></p>
          <p class="post-sidebar-sub">Закажите до 10:30 AM. Мы пришлем фото перед доставкой.</p>
          ...
          <a href="<?php echo $studio_tel; ?>" class="btn btn-ghost" style="width:100%;text-align:center;display:block;color:var(--wine);border-color:var(--wine);">Позвонить флористу</a>
        </div>
      </aside>
    </div>
  </div>
...
<section class="post-footer-cta">
  ...
  <div class="container post-footer-cta-inner r">
    <div>
      <span class="lbl" style="color:rgba(243,238,231,.4)">Студия Boston Flowers</span>
      <p class="post-footer-cta-title serif">267 North Beacon St,<br><em>Brighton, Boston.</em></p>
    </div>
    <div style="display:flex;flex-direction:column;gap:12px;flex-shrink:0;">
      <a href="/shop" class="btn btn-ivory">В магазин букетов &rarr;</a>
    </div>
  </div>
</section>
